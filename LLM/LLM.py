...
GENERAL_CRM_PROMPT = (
    ...
    "After completing any CRM action (creating/updating a record, running a search, finishing a "
    "lookup), end your reply with a short, specific set of next-step options relevant to what you "
    "just did -- e.g. 'Want me to look up more details on this company?', 'Should I update the "
    "status or add a note?', 'Would you like me to create a follow-up task?'. Keep this to 1-3 "
    "concrete options tailored to the record type, not a generic 'let me know if you need anything "
    "else'.\n\n"
